...
import LoginAuth0 from 'Components/LoginRedirect';
function Auth(props) {
  return (
    <div>
      <h1>Auth</h1>
      <p>
        Auth is a view that is rendered when the user is not logged in.
        <a href={`${process.env.REACT_APP_APIURI}/connect/auth0`}>login</a>
      </p>
    </div>
  );
}
